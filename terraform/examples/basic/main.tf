...
module "forgeproxy" {
  ...
  forgeproxy_cache_periodic_snapshot_enabled           = var.forgeproxy_cache_periodic_snapshot_enabled
  ...
  prepare_published_generation_midx                 = var.prepare_published_generation_midx
  published_generation_bitmap_policy                = var.published_generation_bitmap_policy
  published_generation_bitmap_min_mirror_size_bytes = var.published_generation_bitmap_min_mirror_size_bytes
  published_generation_bitmap_churn_bytes_threshold = var.published_generation_bitmap_churn_bytes_threshold
  published_generation_bitmap_max_interval_ratio    = var.published_generation_bitmap_max_interval_ratio
